...
export default function DecisionsClient({
  ...
  initialData: DecisionLedgerItem[];
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
        <KpiCard
          ...
          value={metrics?.total ?? initialData.length}
          icon={ListChecks}
          trend="up"
          trendValue="Decision volume"
        />
        <KpiCard
          title="Approved"
          ...
          icon={UserCheck}
          trend="up"
          trendValue="Successfully executed"
        />
        <KpiCard
        ...
        <KpiCard
          title="Critical Risk"
          value={metrics?.critical ?? highRiskCount}
          icon={ShieldCheck}
          trend="down"
          trendValue="Needs governance"
        />
        <KpiCard
