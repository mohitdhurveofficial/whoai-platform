...
import { Fingerprint, Moon, UserX, Ban } from "lucide-react";
...
export function IdentityStatusBadge({ status }: { status: IdentityStatus }) {
  ...
  switch (status) {
    ...
    case "Orphaned": colorClass = "bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-400"; Icon = UserX; break;
    case "Suspended": colorClass = "bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400"; Icon = Ban; break;
  }
