      ...
      <section className="max-w-[860px] mx-auto px-6 py-20">
        ...
        <div className="space-y-6 mb-14">
          {STEPS.map(({ icon: Icon, title, body }) => (
            <div key={title} className="flex gap-4 rounded-xl border border-[#EEE8E2] bg-white p-6">
        ...
        <div className="mt-12 rounded-2xl border border-[#EEE8E2] bg-white p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
