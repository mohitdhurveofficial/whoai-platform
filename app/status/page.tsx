  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] mx-auto px-6 py-12 bg-[#FAF7F3]">
      <div className="max-w-[800px] mx-auto">
        ...
        {/* Honest status cards — no fabricated historical uptime. */}
        ...
        {/* Recent Incidents — truthful empty state until real incidents occur. */}
        <div className="mb-12">
          ...
          <div className="rounded-lg border border-[#EEE8E2] bg-white p-6 flex items-center gap-3">
            ...
            <p className="text-[15px] text-[#666666]">
              No incidents reported. We&apos;ll post any service disruptions here, with updates until
              resolved.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[#EEE8E2] bg-white p-6">
          ...
          <p className="text-[15px] text-[#666666]">
            No maintenance scheduled. We provide at least 72 hours&apos; notice for any planned
            maintenance that may affect service availability.
          </p>
        </div>

        {/* Contact for status questions */}
