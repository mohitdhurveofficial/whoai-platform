...
const SITE_PAGES = [
  ...
  { title: "Security", url: "/security", desc: "How WHOAI encrypts, isolates, and handles your AI cost data." },
  { title: "Status", url: "/status", desc: "Current operational status for the WHOAI gateway." },
